...
namespace WebReport.Controllers
{
    public class HomeController : Controller
    {
        ...
        public static DataTable TienDoCBQL()
        {
            ...
            string sql;
            sql = "SELECT DISTINCT TT,MA,CHITIEU,THANG,QUY,NAM,KHQUY,KHNAM FROM TienDoCBQL ORDER BY TT ASC";
        ...
        public static DataTable TienDoMLNS()
        {
            DBConnection DB = new DBConnection();
            string sql;
            sql = "SELECT DISTINCT TT,MA,CHITIEU,THANG,QUY,NAM,KHQUY,KHNAM FROM TienDoMLNS ORDER BY TT ASC";
            SqlConnection con = DB.getConnection();
            SqlDataAdapter cmd = new SqlDataAdapter(sql, con);
            DataTable dt = new DataTable();
            try
        ...
        public static DataTable TienDoCBQL1()
        {
            DBConnection DB = new DBConnection();
            string sql;
            sql = "SELECT DISTINCT TT,MA,CHITIEU,THANG,QUY,NAM,KHQUY,KHNAM FROM TienDoCBQL1 ORDER BY TT ASC";
            SqlConnection con = DB.getConnection();
            SqlDataAdapter cmd = new SqlDataAdapter(sql, con);
            DataTable dt = new DataTable();
            try
        ...
        public static DataTable TienDoMLNS1()
        {
            DBConnection DB = new DBConnection();
            string sql;
            sql = "SELECT DISTINCT TT,MA,CHITIEU,THANG,QUY,NAM,KHQUY,KHNAM FROM TienDoMLNS1 ORDER BY TT ASC";
       ...
       //file mau
        ...
        public ActionResult WriteDataToExcel()
        {
            ...
            dt.Columns.Add("TYLEQUY", typeof(string));
            dt.Columns.Add("KHQUY", typeof(string));
            dt.Columns.Add("KHNAM", typeof(string));
            dt.Columns.Add("TYLENAM", typeof(string));
            dt.AcceptChanges();
            //Name of File  
